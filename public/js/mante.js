// función para icono SUBIR Y BAJAR
document.addEventListener('DOMContentLoaded', () => {
    ...
    $(search).on('click', function () {
        ...
        Swal.fire({
            ...
            $.ajax({
                type: "GET",
                url: '/busqueda/interno/mant/' + nroInterno,
                headers: {
                        ...
                        if (documentosVencidos.length > 0) {
                            ...
                            Swal.fire({
                                ...
                                if (result.isConfirmed) {
                                    ...
                                    // Si se cancela, redirigir a la vista de mantenimiento
    ...
    $('#formMant').submit(function (event) {
        event.preventDefault();
       var nroInterno= $('#nroInterno').val();
       var fecha = $('#fecha').val();
       ...
       var observacion = $('#observacion').val();
        if (nroInterno == '') {
            Swal.fire({
                position: "center",
                icon: "info",
                title: "No hay interno",
                text: "Ingrese un numero de interno existente",
                showConfirmButton: true,
        ...
        if (documento == '') {
            Swal.fire({
                position: "center",
                icon: "info",
                title: "No hay conductor!",
                text: "Ingresa documento del conductor",
                showConfirmButton: true,
        ...
        if (observacion == '') {
            Swal.fire({
                position: "center",
                icon: "info",
                title: "No hay Observación!",
                html: 'Ingrese la observación, sí no tiene, Escriba <strong>"No hay observación" </strong> ',
                showConfirmButton: true,
                ...
                success: function (data) {
                    if (data.success) {
                        ...
                        Swal.fire({
                            icon: 'error',
                            title: 'Error',
                            text: 'Hubo un error al crear el mantenimento',
                        });
                    }
                },
